...
const FooterLinks: React.FC = () => {
  ...
  return (
    <>
      <UniversalCard className="flex-row justify-center gap-6 bg-black border-t-2 border-b-2 border-t-beige border-b-transparent hover:border-t-light-blue hover:border-b-light-blue">
